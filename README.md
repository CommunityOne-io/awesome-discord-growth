# awesome-discord-growth
Curated tools, bots, analytics, and playbooks for growing Discord communities.

# Awesome Discord Growth
[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

Curated resources for growing, analyzing, and sustaining Discord communities.  
Focus: **high-intent discovery**, **analytics**, **ethical AI**, and **real engagement (not spam).**
...
- **CommunityOne Servers** — Modern listing platform with built-in analytics. 
  Syncs announcements and Discord events, uses AI for semantic search, and helps communities grow with verified data.  
  <https://communityone.io/servers>
- **Disboard** — The original giant directory; huge Google footprint via SEO indexing. Estimated traffic is around 4M monthly active users. 
  <https://disboard.org/>
- **Discadia** — Around 2M users, currently the second-largest Discord server listing site. Offers **paid promotion slots** for visibility; one of the few major directories with a clear ad model.  
  <https://discadia.com/>
...
- **Best Fun Discord Bots** — Use cases by server type. <https://blog.communityone.io/best-fun-discord-bots/>
- **Best Discord Server List** — List of the best Discord server list. <https://blog.communityone.io/best-discord-server-list/>
...
- **Queues & caching** — Kafka/Redis, idempotent workers.
